...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            btn = [[
            InlineKeyboardButton('⌬ 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐀𝐝𝐦𝐢𝐧 ⌬', url="https://t.me/+sJaVzpXTaExhMGNl")
        ]]        
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("pmfile"):
        ...
        buttons = [[
            InlineKeyboardButton('⭕️𝚄𝙿𝙳𝙰𝚃𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻⭕️', url='https://t.me/+auX77kg8XeI5YTI1')
         ]]
        try:
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 𝐒𝐞𝐚𝐫𝐜𝐡 🔎', url='https://t.me/+7p7DwzUq5WdmYWU1'),
            InlineKeyboardButton('⚡️ 𝐔𝐩𝐝𝐚𝐭𝐞 ⚡️', url='https://t.me/+auX77kg8XeI5YTI1')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>📟 ᴍᴏᴠɪᴇ ɴᴀᴍᴇ:- {search}</b>\n<b>👩🏻‍💻 ʀᴇǫᴜᴇsᴛ:- {message.from_user.mention}</b>\n<b>🚀 ɢʀᴏᴜᴘ:- {message.chat.title} </b>"
...
async def pm_spoll_choker(msg):
    ...
    if not g_s:
        btn = [[
            InlineKeyboardButton('👇 ᴄʟɪᴄᴋ ᴛᴏ ᴄʜᴇᴄᴋ sᴘɪʟʟɪɴɢ ɢᴏᴏɢʟᴇ 👇', callback_data='tipss')
            ],[   
            InlineKeyboardButton('🔍 ꜱᴇᴀʀᴄʜ ɢᴏᴏɢʟᴇ 🔍', url=f'https://google.com/search?q={msg.text.replace(" ", "+")}')
        ]]        
        k=await msg.reply("<b>𝖲ᴏʀʀʏ 𝖭ᴏ 𝖥ɪʟᴇ𝗌 𝖶ᴇʀᴇ 𝖥ᴏᴜɴᴅ.\n\n𝖢ʜᴇᴄᴋ 𝖸ᴏᴜʀ 𝖲ᴘᴇʟʟɪɴɢ ɪɴ 𝖦ᴏᴏɢʟᴇ ᴀɴᴅ 𝖳ʀʏ 𝖠ɢᴀɪɴ. ♻️</b>", reply_markup=InlineKeyboardMarkup(btn))    
        await asyncio.sleep(60)
        await k.delete()
        await msg.delete()
        return
